 ...
 * dungeon secret waypoints or the Secret Routes Mod (SRM).
 */
public class DungeonRoutesPage extends BaseCardGridPage<DungeonRoutesPage.DungeonRoutesOption> {
    ...
    public record DungeonRoutesOption(
        ...
        public static List<DungeonRoutesOption> all() {
            return List.of(fromId("skyblocker_waypoints"), fromId("secret_routes_mod"));
        }

        private static DungeonRoutesOption fromId(String id) {
