...
import com.github.kd_gaming1.packcore.integration.StellaConfigurator;
import net.fabricmc.loader.api.FabricLoader;

import java.util.List;

/**
 * Step: dungeon routes — choose between Skyblocker waypoints and Stella.
...
public final class DungeonRoutesStep implements WizardStep {
    ...
    public void apply(WizardState state) {
        ...
        DungeonRoutesManager.DungeonRoutesMode mode = switch (selectedId) {
            ...
            case "stella" -> DungeonRoutesManager.DungeonRoutesMode.STELLA;
