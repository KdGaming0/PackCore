...
public class UpdateAvailableToast extends BaseOwoToast<FlowLayout> {
    ...
    public UpdateAvailableToast(String currentVersion, String newVersion, String modpackName) {
